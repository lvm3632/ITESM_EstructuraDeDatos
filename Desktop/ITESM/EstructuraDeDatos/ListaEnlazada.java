// Autor: Michel Lujano
// Clase: ListaEnlazada.java (Iteradores)
// Fecha: 03/06/2020
...
public class ListaEnlazada<E>{
	...
	public static void main(String[] args) {
		...
		Iterator<Integer> iterator = test.iterator();
	      ...
	      System.out.println("Valor inicio: "  + test.inicio.valor);
	      System.out.println("Valor final: " + test.fin.valor);
	      System.out.println("Tamano lista: " + test.size);
	...
	public ListaEnlazada(E[] arr) {
		...
		this.size=size-1;
		this.fin=current;
		this.insertarFin(current.valor);
