...
public class MyStack<E> {
	...
	public E pop() {
		...
		try{
			...
			throw new NoSuchElementException("No se puede hacer un pop en una pila vacía");	
		}
	...
	public E top() {
		...
		try {
			...
			throw new NoSuchElementException("No se puede hacer un top en una pila vacía");	
		}
